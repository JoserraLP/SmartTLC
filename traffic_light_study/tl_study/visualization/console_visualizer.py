from tl_study.visualization.visualizer import Visualizer
from tl_study.visualization.utils import generate_random_palette
from tl_study.static.constants import DEFAULT_OUTPUT_FILE, NUM_TRAFFIC_TYPES
import pandas as pd
...
class ConsoleVisualizer:
    ...
    def select_dataset(self):
        ...
        self._dataset_columns = self._visualizer.dataset.columns
    ...
    def select_plot(self):
        ...
        # Maximum possible values of palette is number of traffic types
