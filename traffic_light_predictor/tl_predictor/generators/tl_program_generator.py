...
from tl_predictor.generators.base_generator import BaseGenerator
...
class TrafficLightProgramGenerator(BaseGenerator):
    ...
    def add_static_program(self, phases: list):
        ...
        tl_logic = ET.SubElement(self._root, "tlLogic", id=str(self._cur_id), programID="static_program",
                                 type="static")
