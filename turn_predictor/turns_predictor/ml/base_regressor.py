...
from turns_predictor.ml.utils import calculate_pred_metrics


class BaseRegression:
    """
    Base Regression algorithm class
    """

    def __init__(self):
        """
        Base Regression initializer
        """
        self._model = None
    ...
    def training_process(self, train_features_dataset: pd.DataFrame, train_target_dataset: pd.DataFrame,
        ...
        mse, rmse, mea = calculate_pred_metrics(test_target_dataset, pred_target_dataset)

        return elapsed_time, mse, rmse, mea
