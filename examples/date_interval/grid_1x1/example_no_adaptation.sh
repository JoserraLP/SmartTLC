...
python main.py -o  ../../docker-compose.yml -c mosquitto,influxdb,grafana,telegraf,traffic_light_controller:date#18/07/2021-25/07/2021:load#$cwd:rows#3:cols#3:lanes#2
